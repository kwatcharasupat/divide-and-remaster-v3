...
def make_manifest_and_splits(cfg):
    ...
    speaker_ids = manifest[
        ["speaker_id", "gender", "family", "language", "variant"]
    ].drop_duplicates()
    ...
    stratifier_cols = ["gender", "language", "variant"]
...
def organize_file(
    file, gender, family, langcode, variant, speaker_id, track_id, split, cfg
):
